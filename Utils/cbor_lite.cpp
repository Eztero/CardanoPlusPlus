...
CborSerialize::CborSerialize(std::vector<std::uint8_t> * const cbor_data_out) : bytes_cbor_data(cbor_data_out){
    bytes_cbor_data->reserve(150);   //queda sin efecto si el vector es mayor
};
