#include "../../include/cardanoplusplus/transaction/transactionoutput.hpp"
...
TransactionsOutputs &TransactionsOutputs::addInlineDatumIntValue(std::uint64_t const integer_datum){
...
TransactionsOutputs &TransactionsOutputs::addInlineScript(Cardano::ScriptType const script_type, std::uint8_t const *const script_, std::size_t &script_len ){
...
TransactionsOutputs &TransactionsOutputs::addInlineScript(Cardano::ScriptType const script_type, std::string & script_){
